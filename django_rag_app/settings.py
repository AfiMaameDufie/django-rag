"""
Django settings for django_rag_app project.
...
INSTALLED_APPS = [
    'django_rag_app.apps.MongoAdminConfig',
    'django_rag_app.apps.MongoAuthConfig',
    'django_rag_app.apps.MongoContentTypesConfig',
...
WSGI_APPLICATION = 'django_rag_app.wsgi.application'
